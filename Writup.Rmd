...
##Overview
This was a project for the Practical Machine Learning course on Coursera.  The goal of the project is to develop a machine learning algorithma to predict the "classe" variable in a data set of sensor measurements
